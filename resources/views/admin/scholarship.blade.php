                            ...
                            <tbody>
                               ...
                               @for($i=0; $i < count($scholarship); $i++)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{  route('scholarship_exams',['id' =>$item->id])}}" class="btn btn-info">Open</a></td>

                                    <td>
                                        <a href="{{  route('scholarships_edit',['id' =>$item->id])}}" class="btn btn-primary">Edit</a>
                                        <a href="{{  route('scholarships_destroy',['id' =>$item->id])}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                    </td>
                                </tr>
                                @endfor 
                            </tbody>
