                            ...
                            <tbody>
                               ...
                               @for($i=0; $i < count($scholarship); $i++)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->heading}}</td> 
                                    <td>
                                        <a href="{{  route('rank_calculate',['id' =>$item->id])}}" class="btn btn-primary">Calculate Rank</a>
                                        <a href="{{  route('view_rank_list',['id' =>$item->id])}}" class="btn btn-primary">View Rank List</a>
