...
<body data-bvite="theme-CeruleanBlue" class="layout-border svgstroke-a layout-default rightbar-hide">
	...
	<main class="container-fluid px-0">
				...
				<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvas_Navbar">
					...
					<div class="offcanvas-body flex-column custom_scroll ps-4 ps-xl-0">
						...
						<ul class="list-unstyled mb-4 menu-list">
							...
							<li>
								<a href="/admin/scholarships" aria-label="Scholarship">									
									<span class="mx-2">Scholarships</span>
								</a>
							</li>
							<li>
								<a href="/admin/scholarships/result" aria-label="Scholarship">									
									<span class="mx-2">Scholarship Result</span>
								</a>
							</li>

							<li>
								<a href="/admin/exam_start_time" aria-label="Scholarship">									
									<span class="mx-2">Exam Time</span>
								</a>
							</li>

							{{-- <li>
								<a href="/admin/datatable" aria-label="Scholarship">
									
									<span class="mx-2">Data table</span>
								</a>
							</li> --}}
							
							<li>
								<a href="/admin/get_scholarship_list" aria-label="Scholarship">									
									<span class="mx-2">Exam Results</span>
								</a>
							</li>
							<li>
								<a href="/admin/registration/list" aria-label="Scholarship">									
									<span class="mx-2">Registration</span>
								</a>
							</li>
							<li>
								<a href="/admin/quiz" aria-label="Scholarship">									
									<span class="mx-2">Quiz</span>
								</a>
							</li>
							<li>
								<a href="/admin/mock" aria-label="Scholarship">									
									<span class="mx-2">Mock test</span>
								</a>
							</li>
							<li>
								<a href="/admin/users" aria-label="Scholarship">									
		...
		<footer class="px-md-4 px-2">
			<p class="mb-0 text-muted">Design and developed by <a href="#" target="_blank">Effects world</a></p>
		</footer>
